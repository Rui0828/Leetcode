...
class Solution(object):
    def minCost(self, grid):
        ...
        while priority_queue:
            ...
            current_cost, [current_i, current_j] = priority_queue.pop(0)
            
            if current_cost > min_cost[current_i][current_j]:
                continue
            ...
            if current_j != n-1:
                ...
                if cost < min_cost[current_i][current_j+1]:
                    ...
                    priority_queue.append((cost, [current_i, current_j+1]))
            ...
            if current_i != m-1:
                ...
                if cost < min_cost[current_i+1][current_j]:
                    ...
                    priority_queue.append((cost, [current_i+1, current_j]))
